...
namespace metal
{
    public class SpreadSheetConnector
    {
        ...
        private string _applicationName = "metal-catalog";
        private string _spreadsheetId = "1P_uzYbO3rI6GsR0fUo9BkKsRlQHcfd5mm191i_rZgV8";
        ...
        private void ConnectToGoogle()
        {
            ...
            using (var stream = new FileStream(Path.Combine(HttpRuntime.BinDirectory, "metal-catalog-51f91287eeea.json"),
